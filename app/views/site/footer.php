        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-col">
                    <img src="/logonova.svg" alt="Inova Tanque" class="footer-logo">
                ...
                <div class="footer-col">
                    ...
                    <div class="social-links">
                        ...
                        <a href="<?= whatsapp_link(WHATSAPP_PRINCIPAL, 'Olá! Vim pelo site e gostaria de informações.') ?>" target="_blank" rel="noopener" aria-label="WhatsApp">
