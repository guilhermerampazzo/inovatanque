        ...
        <div class="hero-slide active" style="background: #1a1a1a;">
            <div class="container hero-content">
                ...
                <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                    <a href="<?= whatsapp_link(WHATSAPP_PRINCIPAL, 'Olá! Quero uma cotação de carreta-tanque.') ?>" class="btn btn-whatsapp" target="_blank">
                    ...
                    <a href="/catalogo" class="btn btn-secondary">Ver Equipamentos Disponíveis</a>
                </div>
            </div>
        </div>
    <?php endif; ?>
